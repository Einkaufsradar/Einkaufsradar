  ...
  return (
    <div style={{ background: "#EEF1EA", color: "#1C2B27", minHeight: "100vh", fontFamily: "'Inter', sans-serif" }}>
      <div className="max-w-md mx-auto px-5 py-10">
        ...
        <p className="text-sm font-semibold mb-1">1. Verantwortlicher</p>
        ...
        <p className="text-sm font-semibold mb-1">2. Datenspeicherung im Browser (Local Storage)</p>
        <p className="text-sm leading-relaxed mb-4">
        ...
        <p className="text-sm font-semibold mb-1">3. Datenbank (Supabase)</p>
        <p className="text-sm leading-relaxed mb-4">
        ...
        <p className="text-sm font-semibold mb-1">4. Server-Hosting</p>
        <p className="text-sm leading-relaxed mb-4">
        ...
        <p className="text-sm font-semibold mb-1">5. Keine Analyse-Tools, keine Werbung</p>
        <p className="text-sm leading-relaxed mb-4">
        ...
        <p className="text-sm font-semibold mb-1">6. Deine Rechte</p>
        <p className="text-sm leading-relaxed mb-4">
